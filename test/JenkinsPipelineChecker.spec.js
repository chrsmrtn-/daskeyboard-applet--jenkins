...
describe('JenkinsPipelineChecker', () => {
  describe('the run() method', () => {
    ...
    it('should return the appropriate signal color for a successful pipeline', async () => sut.run().then((signal) => {
    ...
    it('should return the appropriate signal effect for a successful pipeline', async () => sut.run().then((signal) => {
    ...
    it('should return the appropriate signal message for a successful pipeline', async () => sut.run().then((signal) => {
    ...
    it('should return the appropriate signal link for a pipeline', async () => sut.run().then((signal) => {
